package com.crq.article.sample;
...
public class Sample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SendSmsRequest sendSmsRequest = new SendSmsRequest().setSignName("ABC商城").setPhoneNumbers("18851699003").setTemplateCode("SMS_205403269").setTemplateParam("{\"code\":\"123456\"}");
